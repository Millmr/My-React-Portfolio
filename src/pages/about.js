                        ...
                        <blockquote className="blockquote mb-0">
                            <div className="row">
                                ...
                                <div className="col-md-8">
                                    ...
                                    <p className="pgraph">My goal is to is to land a position where I can apply my education, knowledge, and passion in a meaninful way as a Full-Stack Developer</p>
